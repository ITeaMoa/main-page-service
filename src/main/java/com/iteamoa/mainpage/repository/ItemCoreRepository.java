...
public class ItemCoreRepository implements ItemRepository {
    ...
    public List<ItemEntity> queryMostLikedFeed(String feedType) {
        ...
        final DynamoDbIndex<ItemEntity> mostLikedFeedIndex = table.index("MostLikedFeedIndex");
    ...
    public List<ItemEntity> queryPostedFeed(String feedType){
        ...
        final DynamoDbIndex<ItemEntity> postedFeedIndex = table.index("PostedFeedIndex");
    ...
    public List<ItemEntity> queryLikeFeed(Long pk){
        ...
        final DynamoDbIndex<ItemEntity> likeFeedIndex = table.index("LikeFeedIndex");
